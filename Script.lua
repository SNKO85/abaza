...
if UserID == 1619524486 or UserID == 1767874645then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1619524486 or UserID == 1767874645then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
{"اضف رد عشوئي عام","مسح رد عشوائي عام"},
{"تحديث السورس"},
{"الغاء الامر"}}
...
NameUser = Hyper_Link_Name(data)
if UserID == 1619524486 or UserID == 1767874645then 
...
if msg.adduser == 1619524486 or msg.adduser ==  1767874645 then 
gtupe = 'مطور السورس' 
...
return sendMsg(msg.chat_id_,msg.id_,"⇜ ما اقدر اقول اكثر من 100")
end
