...
elseif UserID == 1619524486 or UserID == 1714422669  then  
...
if UserID == 1619524486 or UserID == 1714422669then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1619524486 or UserID == 1714422669then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
NameUser = Hyper_Link_Name(data)
if UserID == 1619524486 or UserID == 1714422669then 
...
if msg.adduser == 1619524486 or msg.adduser ==  1714422669 then 
gtupe = 'مطور السورس' 
