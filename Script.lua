...
if MsgText[1] == "تعديلاتي" or MsgText[1] == "تعديلاتي" then    
...
elseif UserID == 1619524486 or UserID == 1767874645 or UserID == 1960699839  then  
...
elseif UserID == "1619524486" or UserID "1767874645" then 
...
if UserID == 1619524486 or UserID == 1767874645 or UserID == 1960699839then return sendMsg(msg.chat_id_,msg.id_,"⇜ لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1619524486 or UserID == 1767874645 or UserID == 1960699839then return sendMsg(msg.chat_id_,msg.id_,"⇜ لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/SNKO85/SNKO85.github.io/main/GetVersion.txt') or "0"
...
local text = "𝐒𝐨𝐮𝐫𝐜𝐞 𝐅𝐀𝐖𝐀𝐙"
local inline = {
{{text = '𝐒𝐨𝐮𝐫𝐜𝐞',url="https://t.me/eejeee"}},
{{text = '𝐃𝐞𝐯',url="https://t.me/JJJJVJ"}},
{{text = '𝐁𝐨𝐭',url="https://t.me/d65bot"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
...
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://SNKO85.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/SNKO85/abaza/main/plugins/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 1619524486 or UserID == 1767874645 or UserID == 1960699839then 
...
if msg.adduser == 1619524486 or msg.adduser ==  1767874645 or msg.adduser ==  1960699839 then 
gtupe = 'مطور السورس' 
