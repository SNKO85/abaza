...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1767874645 or msg.sender_user_id_ == 1930359414 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/SNKO85/abzaz/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/SNKO85/abzaz/main/inc/locks.lua','./inc/locks.lua')
...
download_file('https://raw.githubusercontent.com/SNKO85/abaza/main/plugins/games.lua','./plugins/games.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "فيدرا.  "
...
result = false
if msg.sender_user_id_ == 1767874645 or msg.sender_user_id_ == 1767874645 then 
SudoBase = true
...
var = 'هذا البوت' 
elseif UserID == 1767874645or UserID == 1767874645 then 
var = 'مطور السورس '
...
message = message ..i.. '( ['..info.username..'](t.me/EEJEEE) )\n'
end
...
elseif UserID == 1767874645 or UserID == 1619524486 then 
...
if UserID == 1910934437 or UserID == 1767874645 then return sendMsg(ChatID,MsgID,"⇠ مايمديك تنزل مطور السورس!") end
