...
keyboardCmd = [[{
"inline_keyboard": [
[{"text": "𝟏","callback_data": "List1"},{"text": "𝟐","callback_data": "List2"}],[{"text": "𝟑","callback_data": "List3"},{"text": "الالعاب","callback_data": "List4"}],
[{"text": "السورس","callback_data": "CmdSudo"},
]}
]]
...
..']}'
msg.KeyboardCmd = list_settings
textMD = [[ اهلا وسهلا بك بسورس فواز

[𝐃𝐞𝐯](https://t.me/jjjjvj)
[[ [𝐒𝐨𝐮𝐫𝐜𝐞](https://t.me/eejeee)
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 1765160742 or msg.sender_user_id_ == 1714422669 then 
Adminn = true
...
if edit then EditMsg(msg.chat_id_,msg.id_,'10% - |█    @jjjjvj     |') end
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███  @jjjjvj       |') end
download_file('https://raw.githubusercontent.com/SNKO85/abaza/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @jjjjvj     |') end
download_file('https://raw.githubusercontent.com/SNKO85/abaza/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @jjjjvj   |') end
download_file('https://raw.githubusercontent.com/SNKO85/abaza/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @jjjjvj  |') end
download_file('https://raw.githubusercontent.com/SNKO85/abaza/main/inc/functions.lua','./inc/functions.lua')
...
usernn = data.username_ or "eejeee"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "eejeee"
end
Name = Name:gsub('[[][]]','')
...
result = false
if msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 1765160742 or msg.sender_user_id_ == 1714422669 then 
SudoBase = true
...
var = 'هذا البوت ' 
elseif UserID == 1619524486 or UserID == 1765160742 or UserID == 1714422669  then 
var = 'مطور السورس'
...
message = message ..i.. '-l ['..info.username..'](t.me/eejeee) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/eejeee) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/eejeee) l » (`' ..v.. '`) \n'
end
end
end
...
if UserID == 1619524486 or UserID == 1765160742 or UserID == 1714422669 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
