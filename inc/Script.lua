...
return '- لا يوجد كليشة السورس اساساً' end
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="كليشه السورس" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(boss..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
if MsgText[1]== 'كليشه السورس' then
if not msg.Director then return "- هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
SUDO_USER = redis:hgetall(boss..'username:'..SUDO_ID).username


local text = [[  اهلا بك بحقوق السورس
للاستفسار - []]..SUDO_USER..[[]
⇜ لم يتم اضافه اي حقوق
⇜ لاضافه حقوق اكتب ( ضع كليشه السورس )
[[ مع تحياتكم فواز المحزم.
...
if msg.text=="م1" or msg.text=="م2" or msg.text=="م3" or msg.text=="م المطور" or msg.text=="كليشه السورس" or msg.text=="الاوامر" or msg.text=="اوامر الملفات" then return false end
