...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "eejeee"))
end
end
...
elseif UserID == 1619524486 or UserID == 1765160742 or UserID == 1767874645  then  
...
elseif UserID == "1619524486" or UserID "1765160742" then 
...
if UserID == 1619524486 or UserID == 1765160742 or UserID == 1767874645then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1619524486 or UserID == 1765160742 or UserID == 1767874645then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
return 'ঌ اصدار سورس فواز*v'..version..'* \n'
end
...
local inline = {{{text="قناه‏‏ السـورس : فواز ",url="t.me/eejeee"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: فواز](t.me/eejeee)',nil,inline,msg.id_)
return false
end
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="السورس" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(boss..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
local text = [[  اهلا بك في حقوق السورس
للاستفسار - []]..SUDO_USER..[[]

⇜ لم يتم اضافه كليشه السورس
⇜ لاضافه الكليشه ارسل تعيين قائمه الاوامر وبعدها السورس وبعدها كليشه سورسك
⇜ وبكذا سويت كليشه بحقوقك مع تحياتي ]]
...
if msg.SudoBase then
local text = '⇜ اهلا عزيزي المـطـور \n⇜ انت المـطـور الاسـاسـي هنا \n\n⇜ تسـتطـيع التحكم بكل الاوامـر المـوجوده بالكيبورد \n⇜ فقط اضغط على الامـر الذي تريد تنفيذه'
...
NameUser = Hyper_Link_Name(data)
if UserID == 1619524486 or UserID == 1765160742 or UserID == 1767874645then 
...
if msg.text=="م1" or msg.text=="م2" or msg.text=="م3" or msg.text=="م المطور" or msg.text=="السورس" or msg.text=="الاوامر" or msg.text=="اوامر الملفات" then return false end
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية فواز ") end
...
if msg.adduser == 1619524486 or msg.adduser ==  1765160742 or msg.adduser ==  1767874645 then 
gtupe = 'مطور السورس' 
...
return sendMsg(msg.chat_id_,msg.id_,"- اعذرني ما اقدر اقول اكثر من 100 حرف")
end
...
return sendMsg(msg.chat_id_,msg.id_,"حددلي الشخص بس وابوسه من عيوني.")
end 
...
elseif not msg.SudoUser and Text=="تويت١" or Text == "كت تويت١" or Text == "كت١" or Text == "تويت١" then
sendMsg(msg.chat_id_,msg.id_,drok[math.random(#drok)])
elseif not msg.SudoUser and Text==" مقالات" or Text == "مقالات" or Text == " مقالات" or Text == "مقالات" then
